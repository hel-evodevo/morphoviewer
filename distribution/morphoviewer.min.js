...
var morphoviewer=function(e){return e.Plane=function(e,t,c){this.point=e,this.planeVec1=vec3.subtract(vec3.create(),t,e),this.planeVec2=vec3.subtract(vec3.create(),c,e),this.normal=vec3.normalize(vec3.create(),vec3.cross(vec3.create(),this.planeVec1,this.planeVec2))},e.Plane.prototype.eval=function(e){mat3.determinant(mat3.fromRows(mat3.create(),e,this.planeVec1,this.planeVec2))},e.Plane.prototype.flip=function(){vec3.subtract(this.planeVec1,vec3.fromValues(0,0,0),this.planeVec1)},e.Plane.prototype.getNormal=function(){return this.normal},e}(morphoviewer||{});
var morphoviewer=function(e){function r(e){var r;r=void 0==e?"glcanvas":e;var a=document.getElementById(r),i=t(a);return i?(i.clearColor(.1,.16,.16,1),i.enable(i.DEPTH_TEST),i.depthFunc(i.LEQUAL),i.clear(i.COLOR_BUFFER_BIT|i.DEPTH_BUFFER_BIT)):alert("morphoviewer.initialize: Unable to initialize WebGL. Your browser may not support it."),[i,a]}function t(e){var r=null;try{r=e.getContext("webgl")||e.getContext("experimental-webgl")}catch(t){}return r}function a(r){var t=new e.Program(r);t.programFromString(e.wireframe.vertex,e.wireframe.fragment);var a=new e.Program(r);a.programFromString(e.color.vertex,e.color.fragment);var i=new e.Program(r);i.programFromString(e.hemisphere.vertex,e.hemisphere.fragment);var o=new e.Program(r);return o.programFromString(e.flatShader.vertex,e.flatShader.fragment),e.flatShader.enableAttributes(r,o),e.flatShader.setAttributes(r,o),[t,a,i,o]}function i(e,r,t){return t>1&&(t=1),vec3.add(vec3.create(),e,vec3.scale(vec3.create(),vec3.subtract(vec3.create(),r,e),t))}function o(r,t,a){r.bind(),e.wireframe.enableAttributes(t,a),e.wireframe.setAttributes(t,a,r.vertices()),r.unbind()}function s(r){r.mesh.bind(),e.color.enableAttributes(r.gl,r.currentProgram),e.color.setAttributes(r.gl,r.currentProgram,r.mesh.vertices(),r.mesh),r.mesh.unbind(),r.renderFunctor=function(){r.mesh.bind(),e.color.setAttributes(r.gl,r.currentProgram,r.mesh.vertices(),r.mesh),e.color.camera=r.camera.matrix(),e.color.model=r.modelView,e.color.setUniforms(r.currentProgram),r.gl.drawArrays(r.gl.TRIANGLES,0,r.mesh.vertices()),r.mesh.unbind()}}var n={};return n.Viewer=function(t){var o=this;this.fps=40,this.renderFunctor=function(){},this.modelView=mat4.create(),this.position=vec3.fromValues(0,0,0),this.targetPosition=vec3.fromValues(0,0,0),this.showTrackball=!0,this.timer=null,this.endTime=null,this.meshCache={vertex:[],normal:[],curvature:[],orientation:[]},this.cameraCache=mat4.create(),this.opcAreaLimit=.3,this.totalModelArea=1,this.mouse={x:0,y:0,prevX:0,prevY:0,dx:0,dy:0},this.leftMouseButtonDown=!1;var s=r(t);this.gl=s[0],this.canvas=s[1];var n=function(e){o.mouse.x=e.pageX,o.mouse.y=e.pageY,o.mouse.dx=o.mouse.x-o.mouse.prevX,o.mouse.dy=o.mouse.y-o.mouse.prevY,o.mouse.prevX=o.mouse.x,o.mouse.prevY=o.mouse.y},c=function(e){var r=window.event||e;r.preventDefault(),r.stopImmediatePropagation();var t=r.detail?-120*r.detail:r.wheelDelta;o.camera.dolly(t*-.0025)},h=function(e){switch(!e.which&&e.button&&(1&e.button?e.which=1:4&e.button?e.which=2:2&e.button&&(e.which=3)),o.mouse.prevX=e.pageX,o.mouse.prevY=e.pageY,e.which){case 1:o.leftMouseButtonDown=!0,o.canvas.onmousemove=function(e){n(e),o.camera.orbit(.004*o.mouse.dx,.004*o.mouse.dy)};break;case 3:o.canvas.onmousemove=function(e){n(e);var r=vec3.scale(vec3.create(),o.camera.up(),-o.mouse.dy*o.camera.distanceFromOrigin()*.001),t=vec3.scale(vec3.create(),o.camera.right(),o.mouse.dx*o.camera.distanceFromOrigin()*.001);vec3.add(o.targetPosition,o.targetPosition,r),vec3.add(o.targetPosition,o.targetPosition,t)}}},m=function(e){switch(!e.which&&e.button&&(1&e.button?e.which=1:4&e.button?e.which=2:2&e.button&&(e.which=3)),e.which){case 1:o.leftMouseButtonDown=!1;break;case 2:break;case 3:}o.canvas.onmousemove=function(e){return!1}};this.canvas.onmousedown=h,this.canvas.onmouseup=m,this.canvas.oncontextmenu=function(e){e.preventDefault()},this.canvas.addEventListener?(this.canvas.addEventListener("mousewheel",c,!1),this.canvas.addEventListener("DOMMouseScroll",c,!1)):this.canvas.addEventListener("onmousewheel",c);var l=this.canvas.clientWidth/this.canvas.clientHeight;this.camera=new e.Camera(60*Math.PI/180,l,.01,1e3),this.mesh=new e.Mesh(this.gl),this.mesh.build({vertex:[],normal:[],curvature:[],orientation:[]}),this.timer=new Date,this.trackball=new e.Trackball(this.gl);var u=[-1,1,0,1,1,0,-1,-1,0,1,1,0,-1,-1,0,1,-1,0];this.showPlane=!1,this.planeObject=new e.BufferObject(this.gl,this.gl.ARRAY_BUFFER),this.planeObject.dataStore(new Float32Array(u),this.gl.STATIC_DRAW),this.planeModelMatrix=mat4.fromScaling(mat4.create(),vec3.fromValues(10,10,10)),this.planeRotationMatrix=mat4.create(),this.planeTranslationMatrix=mat4.create(),this.planeScalingMatrix=mat4.create();var p=function(){o.gl.clear(o.gl.COLOR_BUFFER_BIT|o.gl.DEPTH_BUFFER_BIT),o.endTime=new Date;var r=o.endTime-o.timer;r/=1e3,o.position=i(o.position,o.targetPosition,.5*(1-r)),o.modelView=mat4.create(),mat4.translate(o.modelView,o.modelView,o.position),o.camera.update(r),o.renderFunctor(),o.showTrackball&&(o.currentProgram.stopUsing(),o.lineProgram.use(),e.flatShader.camera=o.camera.matrix(),e.flatShader.model=mat4.create(),e.flatShader.surfaceColor=vec3.fromValues(.7,.7,.7),o.leftMouseButtonDown?(e.flatShader.surfaceColor=vec3.fromValues(.38,.38,1),e.flatShader.setUniforms(o.lineProgram),o.trackball.drawXYCircle(o.lineProgram),e.flatShader.surfaceColor=vec3.fromValues(.38,1,.38),e.flatShader.setUniforms(o.lineProgram),o.trackball.drawXZCircle(o.lineProgram),e.flatShader.surfaceColor=vec3.fromValues(1,.38,.38),e.flatShader.setUniforms(o.lineProgram),o.trackball.drawYZCircle(o.lineProgram)):(e.flatShader.setUniforms(o.lineProgram),o.trackball.draw(o.lineProgram)),o.lineProgram.stopUsing(),o.currentProgram.use()),o.showPlane&&(o.currentProgram.stopUsing(),o.planeProgram.use(),o.planeObject.bind(),e.flatShader.camera=o.camera.matrix(),e.flatShader.model=o.planeScalingMatrix,e.flatShader.surfaceColor=vec3.fromValues(.45,.45,.7),e.flatShader.setUniforms(o.planeProgram),e.flatShader.setAttributes(o.gl,o.planeProgram),o.gl.drawArrays(o.gl.TRIANGLES,0,6),o.planeObject.unbind(),o.planeProgram.stopUsing(),o.currentProgram.use()),o.timer=new Date};setInterval(p,1e3/this.fps,this.gl,this.renderFunctor,this.lineProgram,this.currentProgram,this.trackball,this.camera,this.timer);var v=a(this.gl);this.wireframeProgram=v[0],this.colorProgram=v[1],this.lineProgram=v[3],this.planeProgram=this.lineProgram,this.hemisphereProgram=v[2],this.currentProgram=this.hemisphereProgram,this.viewHemispherical()},n.Viewer.prototype.loadData=function(r){var t=this,a=e.io.getFileType(r);if("stl"===a){var i=e.parseSTL(r),o=i.v,s=i.vn,n=e.surfaceVariation(o,s),c=e.surfaceOrientation(s);e.centerPointCloud(o,"unwrapped"),t.meshCache={vertex:[],normal:[],index:[],orientation:[],curvature:[],wrappedVertex:[],wrappedNormal:[],adjacencyList:[]},t.meshCache.vertex=o,t.meshCache.normal=s,t.meshCache.orientation=c,t.meshCache.curvature=n,t.mesh=new e.Mesh(t.gl),t.mesh.build({vertex:o,normal:s,curvature:n,orientation:c});var h=e.getAabbFromUnwrapped(o);t.planeScalingMatrix=mat4.fromScaling(mat4.create(),vec3.fromValues(.7*h.width,.7*h.height,1)),t.trackball.setRadius(h.length/2.3),t.camera.setBestPositionForModel(h)}else if("ply"===a){for(var i=e.parsePLY(r),o=[],m=i.vertex,l=m.x,u=m.y,p=m.z,v=i.vertex.x.length,g=0;v>g;g++)o.push([l[g],u[g],p[g]]);var d=[],f=i.face.vertex_indices;v=f.length;for(var g=0;v>g;g++)d.push(f[g]);var w=e.adjacencyList(o,d),s=[];if(void 0!==m.nx)for(var P=m.nx,b=m.ny,V=m.nz,g=0;v>g;g++)s.push([P[g],b[g],V[g]]);else s=e.vertexNormals(o,d,w);var c=[];if(void 0!==m.orientation)for(var C=m.orientation,g=0;v>g;g++)c.push(C[g]);var n=[];if(void 0!==i.face.curvature)for(var y=i.face.curvature,g=0;g<y.length;g++)n.push(y[g],y[g],y[g]);e.centerPointCloud(o);var x=e.unwrapVectorArray(o,d),A=e.unwrapVectorArray(s,d);t.meshCache={vertex:[],normal:[],index:[],orientation:[],curvature:[],wrappedVertex:[],wrappedNormal:[],adjacencyList:[]},t.meshCache.vertex=x,t.meshCache.normal=A,t.meshCache.index=d,t.meshCache.wrappedVertex=o,t.meshCache.wrappedNormal=s,t.meshCache.adjacencyList=w,void 0!==m.orientation?t.meshCache.orientation=e.unwrapArray(c,d):t.meshCache.orientation=e.surfaceOrientation(A),void 0!==i.face.curvature?t.meshCache.curvature=n:t.meshCache.curvature=e.surfaceVariation(x,A),t.mesh=new e.Mesh(t.gl),t.mesh.build({vertex:x,normal:A,curvature:t.meshCache.curvature,orientation:t.meshCache.orientation});var h=e.getAabb(o);t.planeScalingMatrix=mat4.fromScaling(mat4.create(),vec3.fromValues(.7*h.width,.7*h.height,1)),t.trackball.setRadius(h.length/2.3),t.camera.setBestPositionForModel(h)}else{if("csv"!==a)return void alert("morphoviewer.Viewer.view: unrecognized file format");var i=e.parseCSV(r,","),o=i.points;e.centerPointCloud(o);var d=e.triangulate(o),w=e.adjacencyList(o,d),s=e.vertexNormals(o,d,w),x=e.unwrapVectorArray(o,d),A=e.unwrapVectorArray(s,d),n=e.surfaceVariation(x,A),c=e.surfaceOrientation(A);t.meshCache={vertex:[],normal:[],index:[],orientation:[],curvature:[],wrappedVertex:[],wrappedNormal:[],adjacencyList:[]},t.meshCache.vertex=x,t.meshCache.normal=A,t.meshCache.index=d,t.meshCache.orientation=c,t.meshCache.curvature=n,t.meshCache.wrappedVertex=o,t.meshCache.wrappedNormal=s,t.meshCache.adjacencyList=w,t.mesh=new e.Mesh(t.gl),t.mesh.build({vertex:x,normal:A,curvature:n,orientation:c});var h=e.getAabb(o);t.trackball.setRadius(h.length/2.3),t.camera.setBestPositionForModel(h),t.planeScalingMatrix=mat4.fromScaling(mat4.create(),vec3.fromValues(.7*h.width,.7*h.height,1))}this.cameraCache=this.camera.rotation(),t.totalModelArea=e.modelArea(t.meshCache.wrappedVertex,t.meshCache.index)},n.Viewer.prototype.view=function(r){var t=this,a=function(e){t.loadData(e)};e.io.loadFile(r,a)},n.Viewer.prototype.viewWireframe=function(){this.currentProgram=this.wireframeProgram,this.currentProgram.use(),o(this.mesh,this.gl,this.currentProgram),this.renderFunctor=function(){this.mesh.bind(),e.wireframe.setAttributes(this.gl,this.currentProgram,this.mesh.vertices()),e.wireframe.camera=this.camera.matrix(),e.wireframe.model=this.modelView,e.wireframe.setUniforms(this.currentProgram),this.gl.drawArrays(this.gl.TRIANGLES,0,this.mesh.vertices()),this.mesh.unbind()}},n.Viewer.prototype.viewSurfaceOrientation=function(){this.mesh.has("orientation")&&(this.currentProgram.object!=this.colorProgram.object&&(this.currentProgram=this.colorProgram,this.currentProgram.use(),s(this)),e.color.colorMode=2)},n.Viewer.prototype.viewSurfaceCurvature=function(){this.mesh.has("curvature")&&(this.currentProgram.object!=this.colorProgram.object&&(this.currentProgram=this.colorProgram,this.currentProgram.use(),s(this)),e.color.colorMode=1)},n.Viewer.prototype.viewHemispherical=function(){this.currentProgram=this.hemisphereProgram,this.currentProgram.use(),this.mesh.bind(),e.hemisphere.enableAttributes(this.gl,this.currentProgram),e.hemisphere.setAttributes(this.gl,this.currentProgram,this.mesh.vertices()),this.mesh.unbind();var r=this;this.renderFunctor=function(){r.mesh.bind(),e.hemisphere.setAttributes(r.gl,r.currentProgram,r.mesh.vertices()),e.hemisphere.camera=r.camera.matrix(),e.hemisphere.model=r.modelView,e.hemisphere.setUniforms(this.currentProgram),r.gl.drawArrays(r.gl.TRIANGLES,0,r.mesh.vertices()),r.mesh.unbind()}},n.Viewer.prototype.viewOrtho=function(){this.camera.viewAsOrtho()},n.Viewer.prototype.viewPerspective=function(){this.camera.viewAsPerspective()},n.Viewer.prototype.viewLeft=function(){this.targetPosition=vec3.fromValues(0,0,0),this.camera.positionLeft()},n.Viewer.prototype.viewRight=function(){this.targetPosition=vec3.fromValues(0,0,0),this.camera.positionRight()},n.Viewer.prototype.viewTop=function(){this.targetPosition=vec3.fromValues(0,0,0),this.camera.positionTop()},n.Viewer.prototype.viewBottom=function(){this.targetPosition=vec3.fromValues(0,0,0),this.camera.positionBottom()},n.Viewer.prototype.viewFront=function(){this.targetPosition=vec3.fromValues(0,0,0),this.camera.positionFront()},n.Viewer.prototype.viewBack=function(){this.targetPosition=vec3.fromValues(0,0,0),this.camera.positionBack()},n.Viewer.prototype.showTrackingball=function(){this.showTrackball=!0},n.Viewer.prototype.hideTrackingball=function(){this.showTrackball=!1},n.color={black:vec3.fromValues(0,0,0),white:vec3.fromValues(1,1,1),lightgray:vec3.fromValues(.91,.91,.91),lightgrey:vec3.fromValues(.91,.91,.91),darkgray:vec3.fromValues(.41,.41,.41),darkgrey:vec3.fromValues(.41,.41,.41)},n.Viewer.prototype.setBackgroundColor=function(e){this.gl.clearColor(e[0],e[1],e[2],1)},n.Viewer.prototype.setFOV=function(e){this.camera.setFOV(Math.PI*e/180)},n.Viewer.prototype.setLightPolarAngle=function(r){e.hemisphere.polar=r},n.Viewer.prototype.setLightAzimuthalAngle=function(r){e.hemisphere.azimuth=r},n.Viewer.prototype.calculateOrientation=function(){this.meshCache.orientation=e.surfaceOrientationAboutCamera(this.meshCache.normal,this.camera.rotation()),this.mesh=new e.Mesh(this.gl),this.mesh.build(this.meshCache),this.cameraCache=this.camera.rotation()},n.Viewer.prototype.setPatchCutoff=function(e){e>=0&&100>e?this.opcAreaLimit=e:console.log("Viewer.setAreaLimit: invalid percentage "+e)},n.Viewer.prototype.opc=function(){if(0===this.meshCache.wrappedVertex.length)return alert("The file format (STL) does not support orientation patch count calculations. Consider converting the file into something else!"),0;for(var r=this.cameraCache,t=this.meshCache.wrappedNormal,a=[],i=8,o=0;o<t.length;o++){var s=r[0]*t[o][0]+r[1]*t[o][1]+r[2]*t[o][2],n=r[3]*t[o][0]+r[4]*t[o][1]+r[3]*t[o][2],c=vec2.normalize(vec2.create(),vec2.fromValues(s,n)),h=e.angleRangeClamp(Math.atan2(c[1],c[0])),m=Math.floor(h/(2*Math.PI/i));m/=i-1,a.push(m)}return count=e.opc(this.meshCache.wrappedVertex,this.meshCache.adjacencyList,a,this.opcAreaLimit,this.totalModelArea)},n.Viewer.prototype.showOpcSelectionPlane=function(){self.showPlane=!0},n.Viewer.prototype.hideOpcSelectionPlane=function(){self.showPlane=!1},n.Viewer.prototype.modelArea=function(){return this.totalModelArea},n.io={},n.io.loadFile=e.io.loadFile,n.io.getFileType=e.io.getFileType,n.io.loadPLY=e.io.loadPLY,n.io.loadOBJ=e.io.loadOBJ,n.io.loadCSV=e.io.loadCSV,n}(morphoviewer);